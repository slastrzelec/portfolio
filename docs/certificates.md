...
Curated list of completed certifications and professional training programs, focused on **Data Science, Machine Learning, Cloud Computing, Python programming, and Security Awareness**.

| Certificate | Provider | Date |
|---|---|---|
| ☁️ Practical Data Science with Amazon SageMaker | Amazon Web Services (AWS) | Dec 2025 |
| 🤖 Become a Data Scientist from Scratch | Work in AI | Nov 2025 |
| 🐍 Practical Python Programming | praktycznypython.pl | Feb 2025 |
...
**Amazon Web Services (AWS)** | *Completed: December 2025*
...
**Work in AI** | *Completed: November 2025*
...
**praktycznypython.pl** | *Completed: February 2025*
